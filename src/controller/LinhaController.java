...
public class LinhaController{
    ...
    private void saveChange(ActionEvent actionEvent) {
        if (searchLinhaTable() != null){
            if (searchLinhaNome(txtNomeLinha.getText()) == null || searchLinhaTable().getNome().equals(txtNomeLinha.getText())){
                ...
                AlertWindow.informationAlerta("Já existe uma linha com esse nome", "Linha não editada.");
            }
        }
        setDisableText(false);
        updateTableLinha();
    ...
    private void addLinha(ActionEvent actionEvent) {
        if (!txtNomeLinha.getText().isEmpty()) {
            ...
            AlertWindow.errorAlert("Nome da linha não inserido", "Linha não adicionada.");
        }
        setVisibleButtonTxtLinha(false);
        updateTableLinha();
        paneImg.setVisible(true);
    ...
    private void saveTrecho(ActionEvent actionEvent) {
        ...
        if(checkTextField(cidadeOrigem, cidadeDestino)){
            if (ucTrecho.searchForOrigemDestino(cidadeOrigem, cidadeDestino) == null){
                ucTrecho.createTrecho(cidadeOrigem, cidadeDestino, tfQuilometragem.getAmount(),
    ...
    @FXML
    private void seeLinhadByClick(MouseEvent mouseEvent) {
        setDisableText(false);
        Linha linha = searchLinhaTable();
        if (linha != null){
